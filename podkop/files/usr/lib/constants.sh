...
## iptables / ipset  (replaces former nft block)
IPT_FAKEIP_MARK="0x00100000"
IPT_OUTBOUND_MARK="0x00200000"
IPT_CHAIN_MANGLE="PODKOP_MANGLE"
IPT_CHAIN_PROXY="PODKOP_PROXY"
IPT_CHAIN_OUTPUT="PODKOP_OUTPUT"
IPT_IPSET_COMMON="podkop_subnets"
IPT_IPSET_DISCORD="podkop_discord_subnets"
IPT_IPSET_LOCALV4="podkop_localv4"
